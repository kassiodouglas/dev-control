...
export type ViewMode = 'dashboard' | 'app-detail' | 'notes' | 'settings' | 'azure-boards' | 'home' | 'docs'; // Updated to match routes
...
export class AppService {
  ...
  // Signals
  apps = signal<LocalApp[]>([]);
  globalNotes = signal<GlobalNote[]>([]);
  ...
  // --- AZURE WRITE ACTIONS (Mock/Real) ---s
